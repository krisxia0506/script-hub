...
```sh
curl -fsSL https://your-host.example/hello | sh
curl -fsSL https://your-host.example/hello@1.0.0 | sh
```
...
Wrangler prints the `workers.dev` URL. The homepage constructs curl commands from the current origin.
